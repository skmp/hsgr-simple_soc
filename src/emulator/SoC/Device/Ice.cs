...
namespace SoC.Device
{
    class Ice
    {
        ...
        // Memory Read/Write
        #region public static ushort ReadMemoryValue(IDevice device, int address)
        public static ushort ReadMemoryValue(IDevice device, int address)
        {
            ushort value = 0;
            byte req;
            byte resp;
        ...
        #endregion
        #region public static void WriteMemoryValue(IDevice device, int address, ushort value)
        public static void WriteMemoryValue(IDevice device, int address, ushort value)
        {
            byte req;
        ...
        // Vram Read/Write
        #region public static ushort ReadVramValue(IDevice device, int address)
        public static ushort ReadVramValue(IDevice device, int address)
        {
            ushort value = 0;
            byte req;
            byte resp;
            ...
            req = (byte)(0x92);                             //8:8 -> read vram to data    -> echo
            WriteCommandWithEchoCheck(device, req);
        ...
        #endregion
        #region public static void WriteVramValue(IDevice device, int address, ushort value)
        public static void WriteVramValue(IDevice device, int address, ushort value)
        {
            byte req;
            ...
            req = (byte)(0x93);                             //9:3 -> write data to vram   -> echo
            WriteCommandWithEchoCheck(device, req);
